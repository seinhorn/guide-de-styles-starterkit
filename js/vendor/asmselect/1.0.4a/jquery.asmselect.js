...
(function($) {
	...
	$.fn.asmSelect = function(customOptions) {
		...
		var options = {
			...
			animateHighlight: false,			// Animate the the show highlight?
		...
		return this.each(function(index) {
			...
			function addListItem(optionId) {
				...
				var $removeLink = $("<a></a>")
					//.attr("href", "#") Modifie pour eviter un retour au top quand on supprime une option
					.attr("href", "")
				...
				if ($O.attr('data-structure') != 'undefined' && $O.attr('data-structure') == 'pere') {
